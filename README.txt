pzzcompressor_jojo was slightly modified to extract pzz files used in GVGNP.

afs_util cannot replace file names with the attributes in AFS archive so attributes.txt is provided for reference.
